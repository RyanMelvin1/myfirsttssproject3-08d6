[myfirsttssproject3-08d6] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [myfirsttssproject3-08d6] container is NOT running**.

.. tip::
   You must have your [myfirsttssproject3-08d6] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/RyanMelvin1/raspberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=46379  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='RyanMelvin1'  \-\-env DOCKERUSERNAME='ryandocker882'  \-\-env MQTTUSERNAME='ryanmelvin@rogers.com'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   ryandocker882/myfirsttssproject3-08d6-amd64 (https://hub.docker.com/r/ryandocker882/myfirsttssproject3-08d6-amd64)
...
.. important::
   docker run -d -p 35511:35511 -p 54187:54187 -p 59321:59321 \-\-env TSS=0 \-\-env SOLUTIONNAME=myfirsttssproject3-08d6 \-\-env SOLUTIONDAG=solution_preprocessing_dag-myfirsttssproject3-08d6 \-\-env GITUSERNAME=RyanMelvin1  \-\-env GITREPOURL=https://github.com/RyanMelvin1/raspberrypi \-\-env SOLUTIONEXTERNALPORT=35511  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=54187  \-\-env SOLUTIONVIPERVIZPORT=59321 \-\-env DOCKERUSERNAME='ryandocker882'  \-\-env EXTERNALPORT=46379 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='ryanmelvin@rogers.com' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  ryandocker882/myfirsttssproject3-08d6-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=59321
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=35511
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - ryandocker882/myfirsttssproject3-08d6-amd64
...
It can be accessed by entering: http://localhost:54187
...
.. important::
   http://localhost:59321/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:59321/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:59321/<html file>
...
[myfirsttssproject3-08d6] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/RyanMelvin1/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/myfirsttssproject3-08d6
...
.. important::
   https://myfirsttssproject3-08d6.readthedocs.io
...
.. important::
   solution_preprocessing_dag-myfirsttssproject3-08d6
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=35511, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=33591, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=33113, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=35149, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=36985, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=41569, HPDEHOST=127.0.1.1, HPDEPORT=46161, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=34483

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-327-myfirsttssproject3-08d6,solution_preprocessing_dag-myfirsttssproject3-08d6, python-preprocess-1064-myfirsttssproject3-08d6,solution_preprocessing_dag-myfirsttssproject3-08d6, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
